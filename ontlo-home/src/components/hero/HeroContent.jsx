      ...
      <div className="flex justify-between items-center w-full gap-2 lg:gap-8 mb-2 lg:mb-6 max-w-sm lg:max-w-none mx-auto lg:mx-0">
        <div className="flex flex-col items-center gap-2 text-center flex-1">
          <div className="text-gray-400">
            <svg className="w-5 h-5 lg:w-6 lg:h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>
          </div>
          <span className="text-[10px] sm:text-xs text-gray-300 font-medium">Privacy First</span>
        </div>
        
        <div className="w-[1px] h-8 bg-gray-800 hidden sm:block opacity-50"></div>
        <div className="w-[1px] h-8 bg-gray-800 sm:hidden opacity-50"></div>
        ...
        <div className="flex flex-col items-center gap-2 text-center flex-1">
          ...
          <span className="text-[10px] sm:text-xs text-gray-300 font-medium">Real Connections</span>
        </div>
        ...
        <div className="flex flex-col items-center gap-2 text-center flex-1">
          <div className="text-gray-400">
            <svg className="w-5 h-5 lg:w-6 lg:h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg>
          </div>
          <span className="text-[10px] sm:text-xs text-gray-300 font-medium">Safe & Secure</span>
        </div>
        ...
        <div className="flex flex-col items-center gap-2 text-center flex-1">
          <div className="text-gray-400">
            <svg className="w-5 h-5 lg:w-6 lg:h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon></svg>
          </div>
          <span className="text-[10px] sm:text-xs text-gray-300 font-medium">Fast & Modern</span>
        </div>
      </div>
